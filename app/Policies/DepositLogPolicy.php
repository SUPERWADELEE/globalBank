...
class DepositLogPolicy
{
    ...
    {
        return $adminUser->can('view_any_deposit::log');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, DepositLog $depositLog): bool
    {
        return $adminUser->can('view_deposit::log');
    }
    ...
    {
        return $adminUser->can('create_deposit::log');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, DepositLog $depositLog): bool
    {
        return $adminUser->can('update_deposit::log');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, DepositLog $depositLog): bool
    {
        return $adminUser->can('delete_deposit::log');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, DepositLog $depositLog): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, DepositLog $depositLog): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, DepositLog $depositLog): bool
    {
