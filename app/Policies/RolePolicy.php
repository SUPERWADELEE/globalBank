...
class RolePolicy
{
    ...
    {
        return $adminUser->can('force_delete_role');
    }
    ...
    {
        return $adminUser->can('force_delete_any_role');
    }
    ...
    {
        return $adminUser->can('restore_role');
    }
    ...
    {
        return $adminUser->can('restore_any_role');
    }
    ...
    {
        return $adminUser->can('replicate_role');
    }
    ...
    {
        return $adminUser->can('reorder_role');
    }
}
