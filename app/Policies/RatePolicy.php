...
class RatePolicy
{
    ...
    {
        return $adminUser->can('view_any_rate');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, Rate $rate): bool
    {
        return $adminUser->can('view_rate');
    }
    ...
    {
        return $adminUser->can('create_rate');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, Rate $rate): bool
    {
        return $adminUser->can('update_rate');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, Rate $rate): bool
    {
        return $adminUser->can('delete_rate');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, Rate $rate): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, Rate $rate): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, Rate $rate): bool
    {
