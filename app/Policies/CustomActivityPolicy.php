...
class CustomActivityPolicy
{
     ...
     */
    public function view(AdminUser $adminUser, CustomActivity $customActivity): bool
    {
     ...
     */
    public function update(AdminUser $adminUser, CustomActivity $customActivity): bool
    {
     ...
     */
    public function delete(AdminUser $adminUser, CustomActivity $customActivity): bool
    {
     ...
     */
    public function forceDelete(AdminUser $adminUser, CustomActivity $customActivity): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, CustomActivity $customActivity): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, CustomActivity $customActivity): bool
    {
