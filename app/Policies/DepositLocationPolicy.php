...
class DepositLocationPolicy
{
    ...
    {
        return $adminUser->can('view_any_deposit::location');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, DepositLocation $depositLocation): bool
    {
        return $adminUser->can('view_deposit::location');
    }
    ...
    {
        return $adminUser->can('create_deposit::location');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, DepositLocation $depositLocation): bool
    {
        return $adminUser->can('update_deposit::location');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, DepositLocation $depositLocation): bool
    {
        return $adminUser->can('delete_deposit::location');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, DepositLocation $depositLocation): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, DepositLocation $depositLocation): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, DepositLocation $depositLocation): bool
    {
