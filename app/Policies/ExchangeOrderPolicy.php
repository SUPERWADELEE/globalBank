...
class ExchangeOrderPolicy
{
    ...
    {
        return $adminUser->can('view_any_exchange::log');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, ExchangeOrder $exchangeOrder): bool
    {
        return $adminUser->can('view_exchange::log');
    }
    ...
    {
        return $adminUser->can('create_exchange::log');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, ExchangeOrder $exchangeOrder): bool
    {
        return $adminUser->can('update_exchange::log');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, ExchangeOrder $exchangeOrder): bool
    {
        return $adminUser->can('delete_exchange::log');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, ExchangeOrder $exchangeOrder): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, ExchangeOrder $exchangeOrder): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, ExchangeOrder $exchangeOrder): bool
    {
