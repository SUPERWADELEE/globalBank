...
class AdminUserTeamPolicy
{
    ...
    {
        return $adminUser->can('view_any_admin::user::team');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, AdminUserTeam $adminUserTeam): bool
    {
        return $adminUser->can('view_admin::user::team');
    }
    ...
    {
        return $adminUser->can('create_admin::user::team');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, AdminUserTeam $adminUserTeam): bool
    {
        return $adminUser->can('update_admin::user::team');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, AdminUserTeam $adminUserTeam): bool
    {
        return $adminUser->can('delete_admin::user::team');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, AdminUserTeam $adminUserTeam): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, AdminUserTeam $adminUserTeam): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, AdminUserTeam $adminUserTeam): bool
    {
